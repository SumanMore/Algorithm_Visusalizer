    ...
    for (let i = 0; i < n - 1; i++) {
        ...
        for (let j = i + 1; j < n; j++) {
            if (arr[j] < arr[min_idx]) {
                console.log(prev);
                if (prev != -1) {
                    x.rows[0].cells[prev].children[0].style.background = 'red'
                    console.log(prev);
                }
        ...
        x.rows[0].cells[min_idx].children[0].style.background = 'red'
        await sleep(1000);
...
function hide(a, b) {
    for (let i = a; i <= b; i++) {
        console.log("exc");
        x.rows[0].cells[i].children[0].style.background = 'orange'
    }
}
